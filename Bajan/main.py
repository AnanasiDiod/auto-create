...
def calculate_pdv_1_pr(width, height, cost_met, cost_cut, cost_bend, cost_vata, cost_axis, num_axis,
    ...
    val_cut_warm = (1367.81 + height * 2 + (851.86 + width)
                    * 2 + 365.8 * 4 + 976 + 834.73 + 1544.57) * cost_cut / 1000
    val_bend_warm = ((height - 4 + width - 4) * 4 + 37 +
                     68.37 * 2 + (225.38 + 137.19) * 2 + 111 * 5) * cost_bend / 1000
    val_vata_warm = (176.94 * 263.94 + 111 * (259.24 + 491.64) +
                     (height - 4 + width - 4) * 39.14) * cost_vata / 10000000
    len_axsis_warm = 0.04
    val_warm_work = 0
    # Учёт наличия ребра
